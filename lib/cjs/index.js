...
const htmlPlugin = (configuration = { files: [], }) => {
    ...
    function collectEntrypoints(htmlFileConfiguration, metafile) {
        const entryPoints = Object.entries((metafile === null || metafile === void 0 ? void 0 : metafile.outputs) || {}).filter(([_, value]) => {
    ...
    function findRelatedOutputFiles(entrypoint, metafile, entryNames) {
        ...
        if (entryNames) {
            ...
            return Object.entries((metafile === null || metafile === void 0 ? void 0 : metafile.outputs) || {}).filter(([pathOfCurrentOutput, _]) => {
                if (entryNames) {
            ...
            return Object.entries((metafile === null || metafile === void 0 ? void 0 : metafile.outputs) || {}).filter(([key, _]) => {
